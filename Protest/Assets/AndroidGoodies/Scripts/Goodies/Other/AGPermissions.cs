...
namespace DeadMosquito.AndroidGoodies
{
    ...
    public static class AGPermissions
    {
        ...
        public class PermissionRequestResult
        {
            ...
            readonly bool _shouldShowRequestPermissionRationale;
            readonly PermissionStatus _status;
            ...
            {
                get { return _shouldShowRequestPermissionRationale; }
            }

            public PermissionRequestResult(string permission, bool shouldShowRequestPermissionRationale, PermissionStatus status)
            {
                _permission = permission;
                _shouldShowRequestPermissionRationale = shouldShowRequestPermissionRationale;
                _status = status;
            }
        ...
        public static bool IsPermissionGranted(string permission)
        {
            ...
            try
            {
                using (var c = new AndroidJavaClass("android.support.v4.content.ContextCompat"))
                {
        ...
        [Obsolete] public const string BIND_CARRIER_MESSAGING_SERVICE =
        ...
        [Obsolete] public const string GET_TASKS = "android.permission.GET_TASKS";
        ...
        [Obsolete] public const string PERSISTENT_ACTIVITY = "android.permission.PERSISTENT_ACTIVITY";
        ...
        [Obsolete] public const string READ_INPUT_STATE = "android.permission.READ_INPUT_STATE";
        ...
        [Obsolete] public const string RESTART_PACKAGES = "android.permission.RESTART_PACKAGES";
        ...
        [Obsolete] public const string SET_PREFERRED_APPLICATIONS =
        ...
        private class OnRequestPermissionsResultsListener : AndroidJavaProxy
        {
            readonly Action<PermissionRequestResult[]> _onResult;

            public OnRequestPermissionsResultsListener(Action<PermissionRequestResult[]> onResult)
                : base(AGActivityUtils.JarPackageName + "PermissionUtils$OnRequestPermissionsResultsListener")
            {
                _onResult = onResult;
            }
