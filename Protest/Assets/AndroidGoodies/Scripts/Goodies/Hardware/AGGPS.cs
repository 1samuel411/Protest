...
namespace DeadMosquito.AndroidGoodies
{
    ...
    public static class AGGPS
    {
        ...
        private class LocationListenerProxy : AndroidJavaProxy
        {
            ...
            private void onStatusChanged(string provider, int status, /*Bundle*/AndroidJavaObject extras)
            {
            }
        ...
        private static Location LocationFromAJO(/*Location*/ AndroidJavaObject locationAJO)
        {
            using (locationAJO)
            {
