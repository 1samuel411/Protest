...
extern "C" {
    ...
    void _sendSms(const char *phoneNumber, const char *msgText,
        ...
        NSString *phoneNumberStr = [IosGoodiesUtils createNSStringFrom:phoneNumber];
        NSString *msgTextStr = [IosGoodiesUtils createNSStringFrom:msgText];
        ...
        NSArray *recipents = @[phoneNumberStr];
