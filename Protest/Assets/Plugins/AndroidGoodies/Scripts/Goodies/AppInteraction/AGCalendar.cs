    ...
    public static class AGCalendar
    {
        ...
        private static class Events
        {
            ...
            public static AndroidJavaObject CONTENT_URI
            {
                get
                {
                    using (var eventsClass = new AndroidJavaClass("android.provider.CalendarContract$Events"))
                    {
        ...
        public class EventBuilder
        {
            ...
            internal EventAccessLevel _accessLevel = EventAccessLevel.Default;
            ...
            public void BuildAndShow()
            {
                ...
                var intent = new AndroidIntent(AndroidIntent.ACTION_INSERT).SetData(Events.CONTENT_URI);
        ...
        public static void OpenCalendarForDate(DateTime dateTime)
        {
            ...
            using (var calendarContractClass = new AndroidJavaClass("android.provider.CalendarContract"))
            {
                using (var contentUri = calendarContractClass.GetStatic<AndroidJavaObject>("CONTENT_URI"))
                {
                    using (var contentUriBuilder = contentUri.CallAJO("buildUpon"))
                    {
                        ...
                        using (var conentUrisClass = new AndroidJavaClass("android.content.ContentUris"))
                        {
