...
namespace DeadMosquito.IosGoodies
{
    ...
    {
        private const string MapsUrl = "http://maps.apple.com/?";
        ...
        public struct Location
        {
            public Location(float latitude, float longitude)
            {
                ...
                {
                    throw new System.ArgumentOutOfRangeException("latitude", "Latitude must be from -90.0 to 90.0.");
                }
                if (longitude < -180.0f || longitude > 180.0f)
                {
                    throw new System.ArgumentOutOfRangeException("longitude", "Longitude must be from -180.0 to 180.0.");
                }
        ...
        private static readonly Dictionary<MapViewType, string> _mapViews = new Dictionary<MapViewType, string>
        {
        ...
        private static readonly Dictionary<TransportType, string> _transportTypes = new Dictionary<TransportType, string>
        {
        ...
        /// </summary>
        /// <param name="query">The query. This parameter is treated as if its value had been typed into the Maps search field by the user.</param>
        /// <param name="viewType">Map view type.</param>
                                         ...
                                         MapViewType viewType = MapViewType.Standard)
        {
            ...
            {
                throw new System.ArgumentOutOfRangeException("zoom", "Zoom level must be between 2 and 23");
            }
                                         ...
                                         MapViewType viewType = MapViewType.Standard)
        {
            ...
            {
                throw new System.ArgumentException("Destination address must not be null or empty", "destinationAddress");
            }
        ...
        private static string EscapeMapQuery(this string str)
        {
            return str.Replace(" ", "+");
        }

        private static string FormatMapsUrl(string format, params object[] args)
        {
